document.addEventListener("DOMContentLoaded", function() {
    ...
    if (currentPath.includes('dialogs.html')) {
        ...
        fetch('https://xquic-cdn-server.fastmsg.ru/api/fastmsg/method/dialogs.get', {
            method: 'POST',
            body: formData
        })
    ...
    if (currentPath.includes('chat.html')) {
        ...
        function loadChatMessages() {
            ...
            fetch('https://xquic-cdn-server.fastmsg.ru/api/fastmsg/method/chat.get', {
                method: 'POST',
                body: formData
            })
            .then(response => response.json())
        ...
        messageForm.addEventListener('submit', function(event) {
            ...
            fetch('https://xquic-cdn-server.fastmsg.ru/api/fastmsg/method/chat.send', {
                method: 'POST',
                body: formData
            })
            .then(response => response.json())
